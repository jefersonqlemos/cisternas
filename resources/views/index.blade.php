                  ...
                  <div class="nav-t-footer">
                    <ul class="nav">
                      ...
                      <li class="has-t-submenu"><a href="solutions.html">Contratar Serviço</a>
                        <ul class="submenu">
                          <li><a href="meterial.html">Instalação de Cisternas</a></li>
                          <li><a href="agricultural.html">Instalação de Calhas</a></li>
                          <li><a href="mechanical.html">Lavação de Calhas e Telhas</a></li>
      ...
      <div class="container clearfix">
        <div class="row">
          ...
          <div class="widget widget-links col-md-3 col-sm-6">
            <h4 class="widget_title">Nossas Soluções</h4>
          ...
          <div class="widget widget-contact col-md-3 col-sm-6">
            <h4 class="widget_title">Entrar em contato</h4>
            <div class="widget-contact-list row m0">
              <ul>
    ...
    <section class="footer-t-bottom footer-bottom footer-bottom3">
      <div class="container clearfix">
        <div class="pull-left fo-txt">
          <p>Copyright © Industiral 2021.. All rights reserved.</p>
        </div>
      </div>
    </section>
